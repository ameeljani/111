...
public class ArtCollage {
    ...
    int temp=tileDimension*collageDimension;
    ...
    for (int col=0; col<tileDimension*collageDimension;col++)
    {
...

        {
             ...
             int scol= col*original.width()/temp;
             int srow= row*original.height()/temp;
    ...
    for (int col=0; col<tileDimension; col++){
         ...
         for (int row=0; row<tileDimension; row++)
         {
            ...
            // System.out.println(col+(collageCol*tileDimension)+" "+row+(collageRow*tileDimension));
